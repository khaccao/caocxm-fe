...
import {  issueActions, getEditIssuePublic, getLabelEdit } from '@/store/issue';
...
export const CreateUpdateCost = ({ labelid }: any) => {
  ...
  // [#20497][dung_lt][26/10/2024] xử lý upload
  ...
  // [#20497][dung_lt][26/10/2024] xử lý xóa file
  ...
  // [#20497][dung_lt][26/10/2024] hàm xác nhận
