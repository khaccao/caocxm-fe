...
import { BCHPayrollType } from './data';
...
export const getBCHColumnFilterProps = (
  dataIndex: keyof BCHPayrollType,
  metaType: MetaType = 'text',
  setSort: (cfg: { key: keyof BCHPayrollType; order: 'asc' | 'desc' }) => void,
  dataSource: BCHPayrollType[],
): Partial<EditableColumn<BCHPayrollType>> => {
  if (metaType === 'text') {
    return {
