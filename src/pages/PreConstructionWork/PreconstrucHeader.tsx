...
export const PreConstruct = () => {
  ...
  const handleGenIssueWithTemplate = async () => {
    ...
    if (company) {
      ...
      dispatch(importFileActions.genIssueRequest({ companyId, tagVersionCode: sMilestone.PrepareForConstruction, body }));
    }
  }
    ...
    <div className={styles.headerContainer}>
      <div className={styles.headerLeft}>
        <div className={styles.titleContainer}>
          ...
          <WithPermission policyKeys={['ChuanBiThiCong.Create']} strategy='disable'>
      ...
      <Tooltip title={t('Import file excel')}>
        ...
        {/* <FloorNumberPopup
          ...
          tagVersionCode={sMilestone.PrepareForConstruction}
