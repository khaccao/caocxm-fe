...
export const YearEndBonus = () => {
  ...
  // [#21110][hao_lt][05/12/2024]_Màn hình Thưởng cuối năm
useEffect(() => {
    if (listDataFileRoots && listDataFileRoots?.results?.length > 0) {
      const rootId = listDataFileRoots.results.find((i: any) => i.labelCode === 'THUONGCUOINAM');
    ...
    // [#21110][hao_lt][05/12/2024]_thêm dependence cho useEffect
  }, [listDataFileRoots]);
  ...
  return (
    <>
      ...
      <DocumentsTable
        pass={activeMenu}
        policies={{
          create: ['KPI.ThuongCuoiNam.Create'],
          delete: ['KPI.ThuongCuoiNam.Delete'],
        }}
      />
    </>
  );
